...
class SearchResult extends React.Component {
    ...
    renderCards() {
        ...
        if(!properties.length) 
            return [1,2,3].map(i=><SkeletonListTile key={i}/>);

        return properties.map((property, i) => <CardWidget key={i} view={view} property={property}/>);
    }
                        ...
                        <Row>
                            ...
                            <Col sm={9}>
                                ...
                                <div className={classes.margin}>
                                    <div className={view == 'list'? classes.grid : classes.marginLess}>
                                        {this.renderCards()}
                                        {
                                            this.state.loading 
